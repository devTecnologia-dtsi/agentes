...
# ======================
ACCESO_AGENTES = {
    "agente-horarios": [RolUsuario.ESTUDIANTE, RolUsuario.DOCENTE],
    "agente-info-personal": [RolUsuario.ESTUDIANTE, RolUsuario.ADMINISTRATIVO],
    "agente-aulas-virtuales": [RolUsuario.ESTUDIANTE, RolUsuario.DOCENTE],
    "agente-notas": [RolUsuario.ESTUDIANTE],
    "agente-presupuesto": [RolUsuario.ADMINISTRATIVO],
    }
